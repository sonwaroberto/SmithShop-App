...
const Menu = ({navigationRef}: {navigationRef: any}) => {
    ...
    <View>
      <View style={styles.menuTop}>
        <View
          ...
          <Text style={{...styles.headerText, fontSize: 24}}>SmithShop</Text>
        </View>
      </View>
      ...
      <View style={styles.menuOptions}>
        ...
        <TouchableOpacity
          ...
          <FontAwesomeIcon color="#fff" icon={faHeart} />
        ...
        <TouchableOpacity
          ...
          <FontAwesomeIcon color="#fff" icon={faCartShopping} />
        ...
        <TouchableOpacity
          ...
          <FontAwesomeIcon color="#fff" icon={faBoxes} />
